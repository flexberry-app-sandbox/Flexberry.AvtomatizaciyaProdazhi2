...
moduleForModel('i-i-s-avtomatizaciya-prodazhi2-зак-покуп', 'Unit | Serializer | i-i-s-avtomatizaciya-prodazhi2-зак-покуп', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-prodazhi2-зак-покуп',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
