...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi2 отч о прод l');

test('testing i-i-s-avtomatizaciya-prodazhi2-отч-о-прод-l', function(assert) {
