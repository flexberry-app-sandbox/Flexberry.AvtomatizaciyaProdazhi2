...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi2 отч ост н скл l');

test('testing i-i-s-avtomatizaciya-prodazhi2-отч-ост-н-скл-l', function(assert) {
