    ...
    public class Контр : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрE", typeof(IIS.Avtomatizaciya_Prodazhi2.Контр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрL", typeof(IIS.Avtomatizaciya_Prodazhi2.Контр));
                }
            }
        }
    }
